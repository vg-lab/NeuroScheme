...
#include <neuroscheme/DataManager.h>
#include <neuroscheme/DomainManager.h>
#include <neuroscheme/Config.h>
#include <neuroscheme/PaneManager.h>
#include <neuroscheme/SelectionManager.h>
#include <neuroscheme/Log.h>
#include <neuroscheme/layouts/CircularLayout.h>
#include <neuroscheme/layouts/GridLayout.h>
#include <neuroscheme/layouts/CameraBasedLayout.h>
#include <neuroscheme/layouts/LayoutManager.h>
#include <neuroscheme/layouts/ScatterPlotLayout.h>
...
// #endif
  ...
  // Active domain
  if ( neuroscheme::Config::inputArgs.count( "-domain" ) == 1 &&
       neuroscheme::Config::inputArgs["-domain"].size( ) == 1 )
  {
    if ( neuroscheme::Config::inputArgs["-domain"][0] == "cortex" )
    {
      neuroscheme::Domain* domain = new neuroscheme::cortex::Domain;
      neuroscheme::DomainManager::setActiveDomain( domain );
      if ( !domain->dataLoader( )->loadData( neuroscheme::Config::inputArgs ))
        exit( -1 );
      // domain->
