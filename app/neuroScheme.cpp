...
#include <neuroscheme/ZeroEQManager.h>
#include <neuroscheme/reps/SelectableItem.h>
...
void parseArguments( int argc, char** argv,
                     neuroscheme::NeuroSchemeInputArguments& args )
{
...
{
  auto& args = neuroscheme::Config::inputArgs;
...
//   }
  ...
  if ( args.count( "-zeroeq" ) == 1 )
  {
    if ( args["-zeroeq"].size( ) == 1 )
      neuroscheme::ZeroEQManager::init( args["-zeroeq"][0] );
    else
    {
      neuroscheme::Log::log( "Error -zeroeq value empty.",
